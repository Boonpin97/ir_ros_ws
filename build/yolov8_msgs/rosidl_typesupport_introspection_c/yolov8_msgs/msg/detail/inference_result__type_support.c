...
static rosidl_typesupport_introspection_c__MessageMember yolov8_msgs__msg__InferenceResult__rosidl_typesupport_introspection_c__InferenceResult_message_member_array[6] = {
  {
    "class_name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs__msg__InferenceResult, conf),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
