...
static const _TimeReq_Request_type_support_symbol_names_t _TimeReq_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, TimeReq_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interfaces, srv, TimeReq_Request)),
  }
};
...
{
  return &::my_interfaces::srv::rosidl_typesupport_cpp::TimeReq_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interfaces, srv, TimeReq_Request)() {
  return get_message_type_support_handle<my_interfaces::srv::TimeReq_Request>();
}
...
static const _TimeReq_Response_type_support_symbol_names_t _TimeReq_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, TimeReq_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interfaces, srv, TimeReq_Response)),
  }
};
...
{
  return &::my_interfaces::srv::rosidl_typesupport_cpp::TimeReq_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interfaces, srv, TimeReq_Response)() {
  return get_message_type_support_handle<my_interfaces::srv::TimeReq_Response>();
}
...
static const _TimeReq_type_support_symbol_names_t _TimeReq_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, TimeReq)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interfaces, srv, TimeReq)),
  }
};
...
{
  return &::my_interfaces::srv::rosidl_typesupport_cpp::TimeReq_service_type_support_handle;
}
